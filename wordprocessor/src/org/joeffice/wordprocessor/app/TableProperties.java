...
/**
 * Represents dialog of table and table's elements properties. User can set
 * table to reflect table's attributes. Row to reflect row's attributes. Cell
 * to reflect cell attributes.
 *
...
public class TableProperties extends JDialog {
    ...
    DocxDocument.TableElement table=null;
    DocxDocument.RowElement row=null;
    DocxDocument.CellElement cell=null;
    ...
    /**
     * Sets table element. Dialog setVisible(true)s table's borders. Dialog setVisible(true)s table
     * width and height but user can't edit these values (we don't know how to
     * distribute changed space between existing rows and columns).
     * Also we always setVisible(true)s margins equal to 2 because different cell can
     * contain different margins values.
     *
    ...
    /**
     * Sets row element. Dialog setVisible(true)s row's borders (Row doesn't process
     * horizontal (inner) border so this check box can contains any value).
     * Dialog setVisible(true)s row width and height but user can't edit only height
     * (we set this height to each of cell).
     * Also we always setVisible(true)s margins equal to 2 because different cell can
     * contain different margins values.
     *
    ...
    /**
     * Sets cell element. Dialog setVisible(true)s cell's borders (cell doesn't process
     * horizontal and vertical (inner) border so thess check boxes can contains
     * any values).
     * Dialog setVisible(true)s cell width and height.
     *
