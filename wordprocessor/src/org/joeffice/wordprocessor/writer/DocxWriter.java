...
//            fillSectPr(wordMLPackage);
     ...
     * @param	pos pos in the document
     * @param	len length of content to be stored
     * @param	content target part
     *
     * @exception	IOException occure when writing is failed.
     */
     ...
     *
     * @param	paragraph source model element
     * @param	pos pos in the document
     * @param	len length of content to be stored
     * @param	content target part
     * @exception	IOException occure when writing is failed.
