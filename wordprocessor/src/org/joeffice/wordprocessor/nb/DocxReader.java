...
public class DocxReader {
     ...
     */
    protected NbEditorDocument document;
        ...
        if (rPr!=null)  {
            ...
            if (rPr.getColor()!=null) {
                ...
                if (!name.toLowerCase().equals("auto")) {
                    Color color=new Color(Integer.parseInt(name.substring(0,2), 16),Integer.parseInt(name.substring(2,4), 16),Integer.parseInt(name.substring(4),16));
