 ...
 *
 * Various properties control how the width of the column is calculated. Another property controls whether column width
 * calculation should be dynamic. Finally, various Actions will be added to the table to allow the user to customize the
 * functionality.
 *
 * This class was designed to be used with tables that use an auto resize mode of AUTO_RESIZE_OFF. With all other modes
 * you are constrained as the width of the columns must fit inside the table. So if you increase one column, one or more
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
    ...
    private boolean isLeaveEmptyAsIs;
    ...
    /**
     * Indicates that columns with no data show not be modified
     */
    public void setLeaveEmptyAsIs(boolean isLeaveEmptyAsIs) {
        this.isLeaveEmptyAsIs = isLeaveEmptyAsIs;
    }
